...
import (
	dto "Sp/providers/betfairStream/dto"
)
...
type MarketSubscriptionMessage struct {
	...
	MarketFilter dto.MarketFilter `json:"marketFilter,omitempty"`
	...
	MarketDataFilter dto.MarketDataFilter `json:"marketDataFilter,omitempty"`
}
